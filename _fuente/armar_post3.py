"""Ensambla post-3.src.html a partir del CSS base del Fijado 1 + extras + cuerpo."""
import pathlib
...
doc = ('<!doctype html><html lang="es"><head><meta charset="utf-8">\n'
       '<title>Renueva Smart — Fijado 3</title>\n'
       '<link rel="stylesheet" href="renueva-fonts.css">\n'
       '<style>' + base + extra + '</style></head><body>\n\n' + cuerpo + '\n</body></html>\n')

HERE.joinpath("post-3.src.html").write_text(doc, encoding="utf-8")
print("post-3.src.html", len(doc) // 1024, "KB")
